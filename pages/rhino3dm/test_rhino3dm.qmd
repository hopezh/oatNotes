...
# loop through layer table to get layers
for i in range(len(layer_table)):
    # print(layer_table[i].Name)
    print('layer ', i, ' :', layer_table[i])
    print('layer ', i, ' id:', layer_table[i].Id)
    print('layer ', i, ' index:', layer_table[i].Index)
    print('layer ', i, ' fullpath: ', layer_table[i].FullPath)
    print()

# get layer idx of each geom 
for i in range(len(model.Objects)):
    print('obj ', i, ' geom: ', model.Objects[i].Geometry)
    print('obj ', i, ' attr: ', model.Objects[i].Attributes)
    print('obj ', i, ' layer idx: ', model.Objects[i].Attributes.LayerIndex)
    print()
